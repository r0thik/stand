...
| Имя VM          | ОС                | Назначение                | Образ |
|----------------|-------------------|---------------------------|-------|
| Ubuntu 64-bit  | Ubuntu Server 20.04.6| Маршрутизатор | ubuntu-20.04.6-live-server-amd64.iso |
| Windows Server 2022 | Windows Server 2022| AD, DNS, DHCP| ru-ru_windows_server_2022_updated_april_2026_x64_dvd_a4d60e24.iso|
| Windows 10 x64| Windows 10| Клиент LAN| ru-ru_windows_10_consumer_editions_version_22h2_updated_oct_2025_x64_dvd_38efd00d.iso|
| kali| Kali Linux | Клиент KALI| kali-linux-2026.1-vmware-amd64|
